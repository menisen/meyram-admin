<template>
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Проекты</h6>
  ...
  <div class="card basic-data-table">
    <div
      ...
      <div class="d-flex align-items-center">
        <a @click="openModal()" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
...
<!--                </th>-->
              ...
              >
                ...
                <td>{{ child.current_members }}</td>
                <td>{{ child.max_members }}</td>
<!--                <td>{{ child.link_url }}</td>-->
<!--                <td>{{ child.banner_url }}</td>-->
<!--                <td>{{ child.trailer_url }}</td>-->
                <td @click.stop>
                  <router-link :to="`/projects/${child.id}/show`"
                               class="w-32-px h-32-px bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center">
                    <Icon icon="iconamoon:eye-light" />
                  </router-link>
                  <router-link :to="`/projects/${child.id}/edit`"
      ...
      <div @click.stop class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
        <div class="modal-content radius-16 bg-base">
          <div class="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
            <h1 class="modal-title fs-5" id="exampleModalLabel">{{ formData.id ? 'Редактировать проект' : 'Добавить проект' }}</h1>
            ...
            <form @submit.prevent="save()">
              <div class="row">
                ...
                <div class="col-6 mb-10">
                  ...
                  <select required v-model="formData.curator_id" class="form-control radius-8 form-select" id="leader_id">

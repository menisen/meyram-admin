              ...
              <form @submit.prevent="save()">
                <div class="row">
                  <div class="col-6 mb-10">
                    ...
                    <input v-model="formData.movies.title" type="text" class="form-control radius-8" placeholder="Введите название">
                  </div>
                  <div class="col-6 mb-10">
                    ...
                    <input v-model="formData.movies.author" type="text" class="form-control radius-8" placeholder="Введите автора">
...
<!--                  </div>-->
                  <div class="col-6 mb-10">
                    ...
                    <select required v-model="formData.movies.genre" class="form-control radius-8 form-select" id="genre">
                  ...
                  <div class="col-6 mb-10">
                    ...
                    <select required v-model="formData.movies.movie_type" class="form-control radius-8 form-select" id="genre">
                  ...
                  <div class="col-6 mb-10">
                    ...
                    <input v-model="formData.movies.premiere_datetime" type="date" class="form-control radius-8" placeholder="Введите ссылку">
                  </div>
                  <div class="col-6 mb-10">
                    <label class="form-label fw-semibold text-primary-light text-sm mb-8">Город</label>
                    <input v-model="formData.movies.city" type="text" class="form-control radius-8" placeholder="Введите город">
                  </div>
                  <div class="col-12 mb-10">
                    <label for="desc" class="form-label fw-semibold text-primary-light text-sm mb-8">Описание</label>
                    <textarea v-model="formData.movies.description" class="form-control" id="desc" rows="4" cols="50" placeholder="Описание"></textarea>
                  </div>
                  ...
                  <template v-if="formData.movies.roles_distribution">
                    <template v-for="(role) in Object.entries(formData.movies.roles_distribution)">
                      <div class="col-12 mt-10 d-flex align-items justify-content-between">
                        ...
                        <button type="button" @click="addRole(role)" class="btn btn-sm btn-primary border border-primary-600 text-md radius-8">Добавить роль</button>
                      </div>
...
<!--                  </template>-->
                ...
                <div class="d-flex align-items-center justify-content-center gap-3 mt-20">
                  <button @click="cancel()" type="button"
                          class="border text-md px-56 py-11 radius-8">
                    Отмена
                  </button>
                  <button @click="remove()" type="button"
                          class="btn btn-danger border border-danger-600 bg-hover-danger-200 text-md px-56 py-11 radius-8">
                    Удалить
                  </button>
                    ...
                    >
                      ...
                      <td>
                        <template v-if="item.full_name">
                          <router-link :to="`/children/${item.id}/show`" class="w-32-px h-32-px bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center mx-4">
...
const save = async () => {
  await api.put(`/movies/${route.params.id}`, {
    ...formData.value.movies,
    premiere_datetime: formData.value.movies.premiere_datetime?.slice(0, 10)
  })
    .then((res) => {

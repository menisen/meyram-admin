            ...
            <div class="col-12">
              ...
              <div class="input-group">
                  <span class="input-group-text bg-base">
                    <img src="https://wowdash.wowtheme7.com/bundlelive/demo/assets/images/card/payment-icon.png" alt="image">
                  </span>
        ...
        <div class="card-body">
          <div class="row gy-3">
            <div class="col-12">
              ...
              <div class="input-group">
                  <span class="input-group-text bg-base">
                    <Icon icon="mynaui:envelope"></Icon>
                  </span>
            ...
            <div class="col-12">
              ...
              <div class="input-group">
                <input type="text" class="form-control" placeholder="www.random.com">
                <button type="button" class="input-group-text bg-base"><Icon icon="lucide:copy"></Icon>   Copy</button>
              </div>
